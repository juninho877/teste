...
$logo_types = [
    'logo_movie_banner' => ['name' => 'Logo Banner Filmes/Séries', 'fixed_filename' => 'logo_movie_banner'],
];

$current_logo_key = 'logo_movie_banner'; // Sempre usar a chave específica para filmes
            ...
            if (in_array($file['type'], $allowedTypes)) {
                ...
                if (move_uploaded_file($file['tmp_name'], $destination)) {
                    ...
                    if ($userImage->saveUserImage($userId, $posted_logo_type, $imagePath, 'file')) {
                        $successMessage = "Logo para banners de filmes/séries atualizado com sucesso!";
                    } else {
...
$pageTitle = "Logo Banners Filmes/Séries";
...
<div class="page-header">
    <h1 class="page-title">
        ...
        Logo para Banners de Filmes/Séries
    </h1>
    <p class="page-subtitle">Configure o logo utilizado nos banners de filmes e séries</p>
</div>
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
    ...
    <div class="card">
        <div class="card-header">
            ...
            <p class="card-subtitle">Prévia do logo atual para banners de filmes/séries</p>
        </div>
        <div class="card-body">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    ...
                    <li class="flex items-center gap-2">
                        <i class="fas fa-check text-success-500"></i>
                        Banners de séries gerados pelo sistema
                    </li>
                    <li class="flex items-center gap-2">
                        <i class="fas fa-check text-success-500"></i>
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    ...
                    <li class="flex items-center gap-2">
                        <i class="fas fa-lightbulb text-warning-500"></i>
                        Resolução recomendada: 300x300px ou maior
                    </li>
                    <li class="flex items-center gap-2">
                        <i class="fas fa-lightbulb text-warning-500"></i>
